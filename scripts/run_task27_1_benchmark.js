...
async function run() {
    console.log("Starting Task 27.1 Benchmark with open-weights model: qwen2.5-coder:14b");
...
Revise your proposal.` });
    ...
    await browser.close();
    fs.writeFileSync(targetFile, originalSource);
    fs.writeFileSync('task27_1_results.json', JSON.stringify(results, null, 2));
    console.log("\
Results:", results);
}
