...
export function MultiNode1() {
  return (
    <div>
      <label data-a11y-id="c6-label" id="c6-label" htmlFor="c6-input">Email</label>
      <input data-a11y-id="c6-input" id="c6-input" type="text" />
    </div>
  );
}
...
export function Struct1() {
  return <div id="c11-div" role="button" tabIndex={5} onClick={() => {}}>Click Me</div>;
}
